...
- **Uzaktan kontrol:** Web panelinden pompa manuel olarak açılıp kapatılabilir, arızalar temizlenebilir. Boş röle kanalları (relay1/2/3) panelde gösterilmez, sadece API üzerinden erişilebilir.
...
- **Su akış animasyonu:** pompa çalışırken hem pompa kontrolünün içinde hem de Sulama panelinin başındaki Giriş/Drenaj boru şeridinde küçük damlacıklar akar; pompa kapalıyken borular durgun görünür.
