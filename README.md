...
- **Röle kontrolü:** sadece pompa gösterilir (tek tıkla aç/kapat). Boş röle kanalları (relay1/2/3) kullanılmadıkları için panelde yer almaz, ileride bir cihaz bağlanırsa eklenebilir.
